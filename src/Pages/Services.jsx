...
import {
  FiGlobe , FiCloud ,FiCpu ,FiSmartphone,FiShield ,FiTrendingUp,FiVolume2 ,FiSliders ,FiCode,FiPieChart,FiTool ,FiEye , FiDatabase,FiLayers,FiKey, FiLink ,FiWifi ,FiInfo } from "react-icons/fi";
    ...
    <>
      <HeroImage title="Services" imageUrl={logo6} />
       <section className="  mx-auto">
         <div className="bg-white py-8 px-6 mt-5">
     
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 00 gap-10">
        {Serving.map((service) => {
