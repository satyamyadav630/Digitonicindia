          ...
          >
            {Serving.map((service, index) => {
              ...
              return (
                <motion.div
                  key={service.id}
                  className="relative bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 ease-in-out hover:-translate-y-2 hover:scale-[1.03] group hover:bg-gradient-to-r hover:from-blue-500 hover:to-indigo-500"
                  custom={index}
